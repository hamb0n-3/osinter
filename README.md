...
osinter -t evilcorp.com -p email-enum
...
osinter -t www.evilcorp.com -p web-basic
...
osinter -t evilcorp.com -p kitchen-sink --allow-deadly
...
```bash
osinter -c modules.virustotal.api_key=dd5f0eee2e4a99b71a939bded450b246
```

For details, see [Configuration](https://www.blacklanternsecurity.com/osinter/Stable/scanning/configuration/).

## Complete Lists of Modules, Flags, etc.

- Complete list of [Modules](https://www.blacklanternsecurity.com/osinter/Stable/modules/list_of_modules/).
- Complete list of [Flags](https://www.blacklanternsecurity.com/osinter/Stable/scanning/#list-of-flags).
- Complete list of [Presets](https://www.blacklanternsecurity.com/osinter/Stable/scanning/presets_list/).
    - Complete list of [Global Config Options](https://www.blacklanternsecurity.com/osinter/Stable/scanning/configuration/#global-config-options).
    - Complete list of [Module Config Options](https://www.blacklanternsecurity.com/osinter/Stable/scanning/configuration/#module-config-options).
...
- **User Manual**
    - **Basics**
        ...
        - [How it Works](https://www.blacklanternsecurity.com/osinter/Stable/how_it_works)
        - [Comparison to Other Tools](https://www.blacklanternsecurity.com/osinter/Stable/comparison)
    - **Scanning**
        - [Scanning Overview](https://www.blacklanternsecurity.com/osinter/Stable/scanning/)
        - **Presets**
            - [Overview](https://www.blacklanternsecurity.com/osinter/Stable/scanning/presets)
            - [List of Presets](https://www.blacklanternsecurity.com/osinter/Stable/scanning/presets_list)
        - [Events](https://www.blacklanternsecurity.com/osinter/Stable/scanning/events)
        - [Output](https://www.blacklanternsecurity.com/osinter/Stable/scanning/output)
        - [Tips and Tricks](https://www.blacklanternsecurity.com/osinter/Stable/scanning/tips_and_tricks)
        - [Advanced Usage](https://www.blacklanternsecurity.com/osinter/Stable/scanning/advanced)
        - [Configuration](https://www.blacklanternsecurity.com/osinter/Stable/scanning/configuration)
    - **Modules**
        - [List of Modules](https://www.blacklanternsecurity.com/osinter/Stable/modules/list_of_modules)
        - [Nuclei](https://www.blacklanternsecurity.com/osinter/Stable/modules/nuclei)
        - [Custom YARA Rules](https://www.blacklanternsecurity.com/osinter/Stable/modules/custom_yara_rules)
    - **Misc**
        - [Contribution](https://www.blacklanternsecurity.com/osinter/Stable/contribution)
        - [Release History](https://www.blacklanternsecurity.com/osinter/Stable/release_history)
        - [Troubleshooting](https://www.blacklanternsecurity.com/osinter/Stable/troubleshooting)
- **Developer Manual**
    ...
    - **Code Reference**
        - [Scanner](https://www.blacklanternsecurity.com/osinter/Stable/dev/scanner)
        - [Presets](https://www.blacklanternsecurity.com/osinter/Stable/dev/presets)
        ...
        - **Helpers**
            ...
            - [Command](https://www.blacklanternsecurity.com/osinter/Stable/dev/helpers/command)
            - [DNS](https://www.blacklanternsecurity.com/osinter/Stable/dev/helpers/dns)
            - [Interactsh](https://www.blacklanternsecurity.com/osinter/Stable/dev/helpers/interactsh)
...
<a href="https://github.com/blacklanternsecurity/osinter/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=blacklanternsecurity/osinter&max=500">
</a>
</p>
...
- Aleksei Kornev (@alekseiko) for granting us ownership of the osinter Pypi repository <3
