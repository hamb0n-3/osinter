...
Below you can find some advanced uses of OSINTER.
...
<!-- OSINTER HELP OUTPUT -->
```text
usage: osinter [-h] [-t TARGET [TARGET ...]] [-w WHITELIST [WHITELIST ...]]
...
Misc:
  --version             show OSINTER version and exit
