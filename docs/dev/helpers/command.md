...
These are helpers related to executing shell commands. They are used throughout OSINTER and its modules for executing various binaries such as `masscan`, `nuclei`, etc.
