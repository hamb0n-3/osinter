...
class OSINTERConfigFiles:
    config_dir = (Path.home() / ".config" / "osinter").resolve()
    defaults_filename = (osinter_code_dir / "defaults.yml").resolve()
    config_filename = (config_dir / "osinter.yml").resolve()
