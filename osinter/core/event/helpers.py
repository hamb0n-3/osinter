...
from osinter.errors import ValidationError
from osinter.core.helpers import validators
from osinter.core.helpers.misc import split_host_port, make_ip_type
from osinter.core.helpers import regexes, smart_decode, smart_encode_punycode
...
It's useful for quickly parsing target lists without the cpu+memory overhead of creating full-fledged OSINTER events

Not every type of OSINTER event needs to be represented here. Only ones that are meant to be targets.
"""
