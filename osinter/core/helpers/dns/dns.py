...
from osinter.errors import DNSError
from osinter.core.engine import EngineClient
from osinter.core.helpers.async_helpers import async_cachedmethod
from ..misc import clean_dns_record, is_ip, is_domain, is_dns_name

from .engine import DNSEngine

log = logging.getLogger("osinter.core.helpers.dns")
...
class DNSHelper(EngineClient):
    ...
    """Helper class for DNS-related operations within OSINTER.

    This class provides mechanisms for host resolution, wildcard domain detection, event tagging, and more.
    It centralizes all DNS-related activities in OSINTER, offering both synchronous and asynchronous methods
    ...
    Attributes:
        ...
        resolver (OSINTERAsyncResolver): An asynchronous DNS resolver tailored for OSINTER with rate-limiting capabilities.
    ...
    Raises:
        DNSError: If an issue arises when creating the OSINTERAsyncResolver instance.
