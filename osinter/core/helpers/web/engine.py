...
from osinter.core.helpers.misc import bytes_to_human, human_to_bytes, get_exception_chain

log = logging.getLogger("osinter.core.helpers.web.engine")
...
class HTTPEngine(EngineServer):
    ...
    def AsyncClient(self, *args, **kwargs):
        ...
        try:
            ...
            client = OSINTERAsyncClient.from_config(self.config, self.target, *args, **kwargs)
