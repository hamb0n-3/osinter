...
from osinter.core.helpers.misc import chain_lists, get_closest_match, get_keys_in_dot_syntax

log = logging.getLogger("osinter.presets.args")
...
class OSINTERArgs:
    ...
    def preset_from_args(self):
        ...
        for preset_arg in self.parsed.preset:
            ...
            except OSINTERArgumentError:
                raise
            except Exception as e:
                raise OSINTERArgumentError(f'Error parsing preset "{preset_arg}": {e}')
        ...
        for config_arg in self.parsed.config:
            try:
                ...
                raise OSINTERArgumentError(f'Error parsing command-line config option: "{config_arg}": {e}')
    ...
    def create_parser(self, *args, **kwargs):
        ...
        misc.add_argument("--version", action="store_true", help="show OSINTER version and exit")
