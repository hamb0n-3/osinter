    ...
    deps_ansible = [
        {
            ...
            "unarchive": {
                "src": "https://github.com/projectdiscovery/nuclei/releases/download/v#{OSINTER_MODULES_NUCLEI_VERSION}/nuclei_#{OSINTER_MODULES_NUCLEI_VERSION}_#{OSINTER_OS}_#{OSINTER_CPU_ARCH}.zip",
                "include": "nuclei",
                "dest": "#{OSINTER_TOOLS}",
                "remote_src": True,
            },
