    ...
    deps_ansible = [
        {
            ...
            "unarchive": {
                "src": "https://github.com/trufflesecurity/trufflehog/releases/download/v#{OSINTER_MODULES_TRUFFLEHOG_VERSION}/trufflehog_#{OSINTER_MODULES_TRUFFLEHOG_VERSION}_#{OSINTER_OS_PLATFORM}_#{OSINTER_CPU_ARCH}.tar.gz",
                "include": "trufflehog",
                "dest": "#{OSINTER_TOOLS}",
                "remote_src": True,
            },
