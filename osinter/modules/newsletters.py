...
# thanks to OSINTER's sub-domain enumeration) looking for the presence of an 'email type' that also
...
class newsletters(BaseModule):
    ...
    async def handle_event(self, event):
        ...
        # Ex: 'osinter -m httpx newsletters -t https://apf-api.eng.vn.cloud.tesla.com' returns
