...
class gowitness(BaseModule):
    ...
    deps_ansible = [
        {
            ...
            "get_url": {
                "url": "https://github.com/sensepost/gowitness/releases/download/#{OSINTER_MODULES_GOWITNESS_VERSION}/gowitness-#{OSINTER_MODULES_GOWITNESS_VERSION}-#{OSINTER_OS_PLATFORM}-#{OSINTER_CPU_ARCH}",
                "dest": "#{OSINTER_TOOLS}/gowitness",
                "mode": "755",
            },
        },
    ]
    ...
    async def handle_batch(self, *events):
        ...
        for filename, screenshot in new_screenshots.items():
            ...
            # NOTE: this prevents long filenames from causing problems in OSINTER, but gowitness will still fail to save it.
