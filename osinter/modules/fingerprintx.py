    ...
    deps_ansible = [
        {
            ...
            "unarchive": {
                "src": "https://github.com/praetorian-inc/fingerprintx/releases/download/v#{OSINTER_MODULES_FINGERPRINTX_VERSION}/fingerprintx_#{OSINTER_MODULES_FINGERPRINTX_VERSION}_#{OSINTER_OS_PLATFORM}_#{OSINTER_CPU_ARCH}.tar.gz",
