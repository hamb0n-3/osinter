    ...
    deps_ansible = [
        {
            "name": "Download httpx",
            "unarchive": {
                "src": "https://github.com/projectdiscovery/httpx/releases/download/v#{OSINTER_MODULES_HTTPX_VERSION}/httpx_#{OSINTER_MODULES_HTTPX_VERSION}_#{OSINTER_OS}_#{OSINTER_CPU_ARCH}.zip",
                "include": "httpx",
                "dest": "#{OSINTER_TOOLS}",
                "remote_src": True,
            },
