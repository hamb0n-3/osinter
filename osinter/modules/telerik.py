...
class telerik(BaseModule):
    ...
    deps_ansible = [
        {"name": "Create telerik dir", "file": {"state": "directory", "path": "#{OSINTER_TOOLS}/telerik/"}},
        {"file": {"state": "touch", "path": "#{OSINTER_TOOLS}/telerik/testfile.txt"}},
        {
