...
class BaseModule:
    """The base class for all OSINTER modules.
    ...
    Attributes:
        ...
        deps_modules (List): Other OSINTER modules this module depends on. Empty list by default.
    ...
    def __init__(self, scan):
        ...
        Args:
            scan: The OSINTER scan object associated with this module instance.
    ...
    def log(self):
        if getattr(self, "_log", None) is None:
            self._log = logging.getLogger(f"osinter.modules.{self.name}")
        return self._log
