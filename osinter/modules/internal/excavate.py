...
from osinter.errors import ExcavateError
import osinter.core.helpers.regexes as osinter_regexes
from osinter.modules.base import BaseInterceptModule
...
class ExcavateRule:
    """
    The OSINTER Regex Commandments:
...
class excavate(BaseInternalModule, BaseInterceptModule):
    ...
    class ParameterExtractor(ExcavateRule):
        ...
        class HtmlTags(ParameterExtractorRule):
            ...
            extraction_regex = osinter_regexes.tag_attribute_regex
            output_type = "GETPARAM"
        ...
        class GetForm(ParameterExtractorRule):
            ...
            form_content_regexes = [
                osinter_regexes.input_tag_regex,
                osinter_regexes.select_tag_regex,
                osinter_regexes.textarea_tag_regex,
            ]
            extraction_regex = osinter_regexes.get_form_regex
            output_type = "GETPARAM"
        ...
        class PostForm(GetForm):
            ...
            extraction_regex = osinter_regexes.post_form_regex
            output_type = "POSTPARAM"
    ...
    class URLExtractor(ExcavateRule):
        ...
        tag_attribute_regex = osinter_regexes.tag_attribute_regex
