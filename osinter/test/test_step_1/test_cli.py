...
from ..osinter_fixtures import *

from osinter import cli
...
async def test_cli_scope(monkeypatch, capsys):
    ...
    monkeypatch.setattr(
        "sys.argv",
        ["osinter", "-t", "one.one.one.one", "-c", "scope.report_distance=10", "dns.minimal=false", "--json"],
    )
...
async def test_cli_scan(monkeypatch):
    ...
    scans_home = osinter_test_dir / "scans"

    # basic scan
    monkeypatch.setattr(
        sys,
        "argv",
        ["osinter", "-y", "-t", "127.0.0.1", "www.example.com", "-n", "test_cli_scan", "-c", "dns.disable=true"],
    )
    result = await cli._main()
    assert result is True
...
async def test_cli_args(monkeypatch, caplog, capsys, clean_default_config):
    ...
    # show version
    monkeypatch.setattr("sys.argv", ["osinter", "--version"])
    result = await cli._main()
    out, err = capsys.readouterr()
    ...
    # deps behavior
    monkeypatch.setattr("sys.argv", ["osinter", "-n", "depstest", "--retry-deps", "--current-preset"])
    result = await cli._main()
    assert result is None
    out, err = capsys.readouterr()
    print(out)
    ...
    # list modules
    monkeypatch.setattr("sys.argv", ["osinter", "--list-modules"])
    result = await cli._main()
    assert result is None
    out, err = capsys.readouterr()
    # internal modules
    ...
    # list output modules
    monkeypatch.setattr("sys.argv", ["osinter", "--list-output-modules"])
    result = await cli._main()
    assert result == None
    out, err = capsys.readouterr()
    # no internal modules
    ...
    output_dir = osinter_test_dir / "osinter_cli_args_output"
    scan_name = "osinter_cli_args_scan_name"
    scan_dir = output_dir / scan_name
    if output_dir.exists():
        shutil.rmtree(output_dir)
    monkeypatch.setattr("sys.argv", ["osinter", "-o", str(output_dir), "-n", scan_name, "-y"])
    result = await cli._main()
    assert result is True
    ...
    # list module options
    monkeypatch.setattr("sys.argv", ["osinter", "--list-module-options"])
    result = await cli._main()
    out, err = capsys.readouterr()
    assert result is None
    ...
    monkeypatch.setattr("sys.argv", ["osinter", "-f", "subdomain-enum", "--list-module-options"])
    result = await cli._main()
    out, err = capsys.readouterr()
    assert result is None
    assert "| modules.wayback.urls" in out
    ...
    monkeypatch.setattr("sys.argv", ["osinter", "-m", "dnsbrute", "-lmo"])
    result = await cli._main()
    out, err = capsys.readouterr()
    assert result is None
    ...
    monkeypatch.setattr("sys.argv", ["osinter", "-om", "stdout", "-lmo"])
    result = await cli._main()
    out, err = capsys.readouterr()
    assert result is None
    ...
    # list flags
    monkeypatch.setattr("sys.argv", ["osinter", "--list-flags"])
    result = await cli._main()
    out, err = capsys.readouterr()
    assert result is None
    assert "| safe " in out
    ...
    monkeypatch.setattr("sys.argv", ["osinter", "-f", "active", "--list-flags"])
    result = await cli._main()
    out, err = capsys.readouterr()
    assert result is None
    ...
    # list multiple flags
    monkeypatch.setattr("sys.argv", ["osinter", "-f", "active", "safe", "--list-flags"])
    result = await cli._main()
    out, err = capsys.readouterr()
    assert result is None
    assert "| safe " in out
    ...
    # no args
    monkeypatch.setattr("sys.argv", ["osinter"])
    result = await cli._main()
    out, err = capsys.readouterr()
    assert result is None
    ...
    # list modules
    monkeypatch.setattr("sys.argv", ["osinter", "-l"])
    result = await cli._main()
    out, err = capsys.readouterr()
    assert result is None
    ...
    monkeypatch.setattr("sys.argv", ["osinter", "-f", "subdomain-enum", "-l"])
    result = await cli._main()
    out, err = capsys.readouterr()
    assert result is None
    assert "| dnsbrute " in out
    ...
    monkeypatch.setattr("sys.argv", ["osinter", "-f", "subdomain-enum", "-rf", "passive", "-l"])
    result = await cli._main()
    out, err = capsys.readouterr()
    assert result is None
    assert "| chaos " in out
    ...
    monkeypatch.setattr("sys.argv", ["osinter", "-f", "subdomain-enum", "-ef", "active", "-l"])
    result = await cli._main()
    out, err = capsys.readouterr()
    assert result is None
    assert "| chaos " in out
    ...
    monkeypatch.setattr("sys.argv", ["osinter", "-f", "subdomain-enum", "-em", "dnsbrute", "-l"])
    result = await cli._main()
    out, err = capsys.readouterr()
    assert result is None
    ...
    monkeypatch.setattr("sys.argv", ["osinter", "-om", "csv,json", "-y"])
    result = await cli._main()
    assert result is True
    assert "Loaded 2/2 output modules, (csv,json)" in caplog.text
    caplog.clear()
    monkeypatch.setattr("sys.argv", ["osinter", "-em", "csv,json", "-y"])
    result = await cli._main()
    assert result is True
    ...
    caplog.clear()
    assert not caplog.text
    monkeypatch.setattr("sys.argv", ["osinter", "-om", "subdomains", "-y"])
    result = await cli._main()
    assert result is True
    ...
    # custom target type
    out, err = capsys.readouterr()
    monkeypatch.setattr("sys.argv", ["osinter", "-t", "ORG:evilcorp", "-y"])
    result = await cli._main()
    out, err = capsys.readouterr()
    assert result is True
    ...
    caplog.clear()
    assert not caplog.text
    monkeypatch.setattr("sys.argv", ["osinter", "-f", "passive"])
    result = await cli._main()
    assert result is True

    # unconsoleable output module
    monkeypatch.setattr("sys.argv", ["osinter", "-om", "web_report"])
    result = await cli._main()
    assert result is True

    # unresolved dependency
    monkeypatch.setattr("sys.argv", ["osinter", "-m", "wappalyzer"])
    result = await cli._main()
    assert result is True

    # require flags
    monkeypatch.setattr("sys.argv", ["osinter", "-f", "active", "-rf", "passive"])
    result = await cli._main()
    assert result is True

    # excluded flags
    monkeypatch.setattr("sys.argv", ["osinter", "-f", "active", "-ef", "active"])
    result = await cli._main()
    assert result is True

    # slow modules
    monkeypatch.setattr("sys.argv", ["osinter", "-m", "bucket_digitalocean"])
    result = await cli._main()
    assert result is True
...
async def test_cli_customheaders(monkeypatch, caplog, capsys):
    ...
    # test custom headers
    monkeypatch.setattr(
        "sys.argv", ["osinter", "--custom-headers", "foo=bar", "foo2=bar2", "foo3=bar=3", "--current-preset"]
    )
    success = await cli._main()
    ...
    monkeypatch.setattr("sys.argv", ["osinter", "--custom-headers", "justastring", "--current-preset"])
    result = await cli._main()
    assert result is None
    ...
    monkeypatch.setattr("sys.argv", ["osinter", "--custom-headers", "=nokey", "--current-preset"])
    result = await cli._main()
    assert result is None
    ...
    monkeypatch.setattr("sys.argv", ["osinter", "--custom-headers", "missingvalue=", "--current-preset"])
    result = await cli._main()
    assert result is None
    assert "Custom headers not formatted correctly (missing header name or value)" in caplog.text
...
async def test_cli_module_help(monkeypatch, capsys):
    ...
    monkeypatch.setattr("sys.argv", ["osinter", "--module-help", "excavate"])
    success = await cli._main()
...
def test_cli_config_validation(monkeypatch, caplog):
    ...
    caplog.clear()
    assert not caplog.text
    monkeypatch.setattr("sys.argv", ["osinter", "-c", "modules.ipnegibhor.num_bits=4"])
    cli.main()
    ...
    caplog.clear()
    assert not caplog.text
    monkeypatch.setattr("sys.argv", ["osinter", "-c", "web_spier_distance=4"])
    cli.main()
...
def test_cli_module_validation(monkeypatch, caplog):
    ...
    caplog.clear()
    assert not caplog.text
    monkeypatch.setattr("sys.argv", ["osinter", "-m", "dnsbrutes"])
    cli.main()
    ...
    caplog.clear()
    assert not caplog.text
    monkeypatch.setattr("sys.argv", ["osinter", "-em", "dnsbrutes"])
    cli.main()
    ...
    caplog.clear()
    assert not caplog.text
    monkeypatch.setattr("sys.argv", ["osinter", "-om", "neoo4j"])
    cli.main()
    ...
    caplog.clear()
    assert not caplog.text
    monkeypatch.setattr("sys.argv", ["osinter", "-om", "websocket", "-c", "modules.websocket.url=", "-y"])
    cli.main()
    ...
    assert 1 == len(
        [
            l
            for l in lines
            if l.startswith("WARNING  osinter.scanner:scanner.py")
    ...
    assert 1 == len(
        [
            l
            for l in lines
            if l.startswith("WARNING  osinter.modules.output.websocket:base.py") and l.endswith("Setting error state")
        ]
    )
    assert 1 == len(
        [
            l
            for l in lines
            if l.startswith("ERROR    osinter.cli:cli.py")
    ...
    monkeypatch.setattr(
        "sys.argv",
        ["osinter", "-om", "websocket", "-em", "python,stdout,csv,json,txt", "-c", "modules.websocket.url=", "-y"],
    )
    cli.main()
    lines = caplog.text.splitlines()
    ...
    assert 1 == len(
        [
            l
            for l in lines
            if l.startswith("ERROR    osinter.cli:cli.py") and l.endswith("Failed to load output modules. Aborting.")
        ]
    )
    ...
    caplog.clear()
    assert not caplog.text
    monkeypatch.setattr("sys.argv", ["osinter", "-t", "asdf:::sdf"])
    cli.main()
    ...
    caplog.clear()
    assert not caplog.text
    monkeypatch.setattr("sys.argv", ["osinter", "-f", "subdomainenum"])
    cli.main()
    ...
    caplog.clear()
    assert not caplog.text
    monkeypatch.setattr("sys.argv", ["osinter", "-ef", "subdomainenum"])
    cli.main()
    assert 'Could not find flag "subdomainenum"' in caplog.text
    assert 'Did you mean "subdomain-enum"?' in caplog.text
    ...
    caplog.clear()
    assert not caplog.text
    monkeypatch.setattr("sys.argv", ["osinter", "-rf", "subdomainenum"])
    cli.main()
    assert 'Could not find flag "subdomainenum"' in caplog.text
    assert 'Did you mean "subdomain-enum"?' in caplog.text
...
def test_cli_presets(monkeypatch, capsys, caplog):
    ...
    # show current preset
    monkeypatch.setattr("sys.argv", ["osinter", "-c", "web.http_proxy=currentpresettest", "--current-preset"])
    cli.main()
    captured = capsys.readouterr()
    assert "    http_proxy: currentpresettest" in captured.out

    # show current preset (full)
    monkeypatch.setattr("sys.argv", ["osinter", "-cmodules.c99.api_key=asdf", "--current-preset-full"])
    cli.main()
    captured = capsys.readouterr()
    assert "      api_key: asdf" in captured.out

    preset_dir = osinter_test_dir / "test_cli_presets"
...
config:
  web:
    ...
    monkeypatch.setattr("sys.argv", ["osinter", "-p", str(preset1_file.resolve()), "--current-preset"])
    cli.main()
    captured = capsys.readouterr()
    stdout_preset = yaml.safe_load(captured.out)
    ...
    monkeypatch.setattr(
        "sys.argv", ["osinter", "-p", str(preset2_file.resolve()), str(preset1_file.resolve()), "--current-preset"]
    )
    cli.main()
    captured = capsys.readouterr()
    stdout_preset = yaml.safe_load(captured.out)
    ...
    # override other way
    monkeypatch.setattr(
        "sys.argv", ["osinter", "-p", str(preset1_file.resolve()), str(preset2_file.resolve()), "--current-preset"]
    )
    cli.main()
    captured = capsys.readouterr()
    stdout_preset = yaml.safe_load(captured.out)
    ...
    # --fast-mode
    monkeypatch.setattr("sys.argv", ["osinter", "--current-preset"])
    cli.main()
    captured = capsys.readouterr()
    stdout_preset = yaml.safe_load(captured.out)
    assert list(stdout_preset) == ["description"]

    monkeypatch.setattr("sys.argv", ["osinter", "--fast", "--current-preset"])
    cli.main()
    captured = capsys.readouterr()
    stdout_preset = yaml.safe_load(captured.out)
    ...
    # --proxy
    monkeypatch.setattr("sys.argv", ["osinter", "--proxy", "http://127.0.0.1:8080", "--current-preset"])
    cli.main()
    captured = capsys.readouterr()
    stdout_preset = yaml.safe_load(captured.out)
    stdout_preset.pop("description")
    ...
    caplog.clear()
    assert not caplog.text
    monkeypatch.setattr("sys.argv", ["osinter", "-p", "asdfasdfasdf", "-y"])
    cli.main()
    ...
    output_dir_preset_file = osinter_test_dir / "output_dir_preset.yml"
    scan_name = "cli_output_dir_test"
    output_dir = osinter_test_dir / "cli_output_dir_preset"
    scan_dir = output_dir / scan_name
...
scan_name: {scan_name}
    ...
    monkeypatch.setattr("sys.argv", ["osinter", "-p", str(output_dir_preset_file.resolve()), "--current-preset"])
    cli.main()
    captured = capsys.readouterr()
    stdout_preset = yaml.safe_load(captured.out)
    ...
    monkeypatch.setattr("sys.argv", ["osinter", "-p", str(output_dir_preset_file.resolve())])
    cli.main()
    captured = capsys.readouterr()
    assert output_dir.is_dir()
    assert scan_dir.is_dir()
