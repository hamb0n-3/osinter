...
from osinter.scanner import Scanner, Preset
...
def test_preset_cache():
    preset_file = osinter_test_dir / "test_preset.yml"
    yaml_string = """
flags:
  - subdomain-enum
...
"""
    ...
    from osinter.scanner.preset.preset import _preset_cache
...
async def test_preset_module_loader():
    custom_module_dir = osinter_test_dir / "custom_module_dir"
...
"""
    ...
    with open(custom_module_3, "w") as f:
        f.write(
            """
from osinter.modules.internal.base import BaseInternalModule
...
"""
    ...
    custom_module_dir_3 = osinter_test_dir / "custom_module_dir_3"
...
def test_preset_include():
    ...
    custom_preset_dir_1 = osinter_test_dir / "custom_preset_dir"
    custom_preset_dir_2 = custom_preset_dir_1 / "preset_subdir"
    custom_preset_dir_3 = custom_preset_dir_2 / "subsubdir"
    custom_preset_dir_4 = Path("/tmp/.osinter_preset_test")
...
config:
  web:
    ...
    spider_depth: 2
"""
    custom_preset_dir = osinter_test_dir / "custom_preset_dir_override"
...
async def test_preset_output_dir():
    output_dir = osinter_test_dir / "preset_output_dir"
    preset = Preset.from_yaml_string(
        f"""
output_dir: {output_dir}
scan_name: osinter_test
"""
    )
    scan = Scanner(preset=preset)
    await scan.async_start_without_generator()
    scan_dir = output_dir / "osinter_test"
...
# regression test for https://github.com/blacklanternsecurity/osinter/issues/2337
