...
class TestGithub_Workflows(ModuleTestBase):
    ...
    async def setup_before_prep(self, module_test):
        ...
        module_test.httpx_mock.add_response(
            url="https://api.github.com/repos/blacklanternsecurity/osinter/actions/runs/8839360698/artifacts",
            json={
                "total_count": 1,
                "artifacts": [
                    {
                        ...
                        "url": "https://api.github.com/repos/blacklanternsecurity/osinter/actions/artifacts/1829832535",
                        "archive_download_url": "https://api.github.com/repos/blacklanternsecurity/osinter/actions/artifacts/1829832535/zip",
                        "expired": False,
        ...
        module_test.httpx_mock.add_response(
            url="https://api.github.com/repos/blacklanternsecurity/osinter/actions/artifacts/1829832535/zip",
            headers={
