...
from osinter.core.helpers.libmagic import get_magic_info
from osinter.test.test_step_2.module_tests.base import ModuleTestBase, tempapkfile
...
class TestJadx(ModuleTestBase):
    ...
    async def setup_after_prep(self, module_test):
        ...
        module_test.httpx_mock.add_response(
            url="https://d.apkpure.com/b/XAPK/com.osinter.test?version=latest",
            content=self.apk_file,
            headers={
                "Content-Type": "application/vnd.android.package-archive",
                "Content-Disposition": "attachment; filename=com.osinter.test.apk",
            },
        )
