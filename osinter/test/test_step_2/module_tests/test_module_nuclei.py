    ...
    config_overrides = {
        ...
        "modules": {
            "nuclei": {
                ...
                "concurrency": 2,
                "ratelimit": 10,
                "templates": "/tmp/.osinter_test/tools/nuclei-templates/http/miscellaneous/",
    ...
    config_overrides = {
        "modules": {
            "nuclei": {
                "mode": "severe",
                "concurrency": 1,
                "templates": "/tmp/.osinter_test/tools/nuclei-templates/vulnerabilities/generic/generic-linux-lfi.yaml",
            }
        },
        "interactsh_disable": True,
    }
    ...
    config_overrides = {
        "modules": {
            "nuclei": {
                ...
                "concurrency": 1,
                "tags": "spiderfoot",
                "templates": "/tmp/.osinter_test/tools/nuclei-templates/exposed-panels/spiderfoot.yaml",
                "interactsh_disable": True,
            }
        }
    }
