...
class TestPostman(ModuleTestBase):
    ...
    async def setup_after_prep(self, module_test):
                ...
                "data": [
                    ...
                    },
                    {
                        ...
                        "document": {
                            ...
                            "universaltags": "",
                            "views": 5788,
                            "summary": "Private test of OSINTERs public API",
                            "memberCount": 2,
                            "isBlacklisted": False,
                            "publisherid": "299401",
                            "isPrivateNetworkEntity": False,
                        ...
                        "highlight": {"summary": "Private test of OSINTERs Public API"},
                    },
                ],
                "meta": {
        ...
        module_test.httpx_mock.add_response(
            url="https://www.postman.com/_api/ws/proxy",
            match_content=b'{"service": "workspaces", "method": "GET", "path": "/workspaces?handle=testteam&slug=testing-osinter-api"}',
            json={
                "meta": {"model": "workspace", "action": "find", "nextCursor": ""},
                "data": [
                    {
    ...
    def check(self, module_test, events):
        ...
        assert 1 == len(
            [
                ...
                and e.data["url"] == "https://www.postman.com/blacklanternsecurity/osinter-public"
